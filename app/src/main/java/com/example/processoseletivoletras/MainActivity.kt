...
/*  Descrição geral do funcionamento do programa:
    ...
    SongItem é uma classe de dados que guarda o título da música e o seu score.
        ...
        Utilizamos a função de lowercase() do Kotlin e a função de extensão String.removeAccents()
    para tratar o textos de entrada e os títulos das músicas antes da aplicação do algoritmo.
    Agora podemos comparar o texto de entrada com todos nomes no banco de músicas e calcular o score
    ...
    função GetFilter(), implementada na classe SongsAdapter (que adapta o dataset para que
    seja transformado em views).
    ...
    um mesmo índice, adiciona-se então 1 ponto para cada letra igual.
    Na primeira iterada, descontamos 5 pontos para o caso do título da música conter a palavra 'feat'.

        Após obtermos todos os scores, ordenamos as músicas em ordem decrescente de score utilizando
    o sortByDescending() do Kotlin e pegamos os 10 primeiros SongItems para exibir ao usuário em forma
